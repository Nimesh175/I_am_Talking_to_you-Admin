...
import { StyleSheet, View, Platform, Text ,TouchableHighlight ,TouchableWithoutFeedback} from 'react-native';
...
import { dimensions , _getShadows } from '../../../configurations/constants'
...
const VideoPlayer = ({url , vidWidth=400 , vidHeight=300 } ) => {
    ...
    const backgroundVideo = {
        ...
        // width: isFullScreen ? 720 : vidWidth,

        height : isFullScreen ? '100%' :vidHeight,
        width: isFullScreen ? 720 : vidWidth,
    }
    // width : 720 --> dimension width not working here
    ...
    const frontShadowLayer01={
        ...
        // alignItems: 'center',
        // top: isFullScreen ? '206%' : '202%',
        // left: isFullScreen ? '27%' : '16%',
        // padding: 10,
    ...
    // for style the components
     const  frontShadowLayer02 = {
        ...
        // justifyContent: 'center',
        // alignItems: 'center',
        // top: isFullScreen ? '206%' : '200%',
        // right : isFullScreen ? '27%' : '21%',
        // padding: 10,
        // paddingHorizontal : 18,
    }
     ...
     const  frontShadowLayer03 = {
        ...
        // justifyContent: 'center',
        // alignItems: 'center',
        // top:  !isFullScreen ?'196%' : '199%',
        // right :  !isFullScreen ?'38%' : '45%',
        // paddingVertical : 15,
        // paddingHorizontal : 25,
    }

    const playSkipContainer ={
        flexDirection : 'row',
        width : '100%',
    ...
    return (
        <View style={{ ...styles.container  , marginTop : isFullScreen ? 0 : 50 }}>   
            <Video
                onEnd={onEnd}
                onLoad={onLoad}
                ...
                resizeMode={isFullScreen ? 'cover' : 'cover'}
                source={video}
            ...
            {/* forwad and backword buttons         */}
                 <View style={playSkipContainer}>
                 <TouchableHighlight onPress={ goBackword } style={{padding : 10}}  underlayColor= 'rgba(0,0,0,0.2)' >
                        <View>
                            <MaterialCommunityIcons name="rewind-10" style={{ fontSize : 24, color : 'rgba(255,255,255,0.9)'}}/>
                        </View>
                    </TouchableHighlight>
                    

                    <TouchableWithoutFeedback onPress={ onPaused }  style={{padding : 10}}  underlayColor= 'rgba(0,0,0,0.2)' >
                        <View>
                    ...
                    <TouchableHighlight onPress={ goForward } style={{padding : 10}}  underlayColor= 'rgba(0,0,0,0.2)' >
                        <View>
