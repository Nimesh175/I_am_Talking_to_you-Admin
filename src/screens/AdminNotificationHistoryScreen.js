                    ...
                    <EmptyView  style={{marginTop : dimensions.heightLevel7}} /> 
                      ...
                      <EmptyView  style={{marginTop : dimensions.heightLevel6}} /> 
                         ...
                         <ListButton name={" delete "} />
                              <EmptyView  style={{margin : dimensions.heightLevel1 * 0.5}} /> 
                         <ListButton name={" update "} customButton={styles.button} customButtonText={styles.buttonText} />
                     </View>
...
export default AdminNotificationHistoryScreen
